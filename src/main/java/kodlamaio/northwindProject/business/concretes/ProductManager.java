...
import kodlamaio.northwindProject.business.abstracts.ProductService;
...
import kodlamaio.northwindProject.dataAccess.abstracts.ProductDao;
...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getAllSorted() {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(sort), "Listelendi");
	}
